...
def render_index_content():
    ...
    if last_event:
        ...
        if last_event.fotos and len(last_event.fotos) > 0:
            cover = url_for('static', filename='uploads/' + last_event.fotos[0].filename)
        else:
    ...
    if not photos:
        ...
        for p in photos:
            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                <img src=\"""" + url_for('static', filename='uploads/' + p.filename) + """\" class="img-fluid" style="height:220px;object-fit:cover;border-radius:8px" />
                <div class="card-body">
                  <p>""" + (p.comentario or '') + """</p>
                </div>
              </div>
